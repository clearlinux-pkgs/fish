...
Source0  : https://github.com/fish-shell/fish-shell/releases/download/3.7.1/fish-3.7.1.tar.xz
Source1  : https://github.com/fish-shell/fish-shell/releases/download/3.7.1/fish-3.7.1.tar.xz.asc
...
%prep
%setup -q -n fish-3.7.1
cd %{_builddir}/fish-3.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710856694
mkdir -p clr-build
pushd clr-build
