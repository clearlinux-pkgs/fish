...
Source0  : https://github.com/fish-shell/fish-shell/releases/download/3.6.3/fish-3.6.3.tar.xz
Source1  : https://github.com/fish-shell/fish-shell/releases/download/3.6.3/fish-3.6.3.tar.xz.asc
...
%prep
%setup -q -n fish-3.6.3
cd %{_builddir}/fish-3.6.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701711999
mkdir -p clr-build
pushd clr-build
